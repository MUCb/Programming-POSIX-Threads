...
/*
 * Thread start routine that reports it ran, and them exits.
 */
...
int main (int argc, char *argv[])
{
    ...
    /*
     * If supported, determine the default stack size and report it, 
     * and then select a stack size for the new thread.
     *
    ...
    if (status != 0)
        err_abort (status, "Set stack thread");
#endif
