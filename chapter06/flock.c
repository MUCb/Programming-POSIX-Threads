...
/*
 * This routine writes  a prompt to stdout (passes as the thread's
 * "args"), and reads a response. All other I/O to stdin and stdout
...
int main (int argc, char * argv[])
{
     ...
     * that our threads can run concurrently, we need to increase the concurrency level.
     */
